...
class Month < Test::Unit::TestCase
   ...
   def test_01_get_month
     month = "02"
     assert_equal("February", get_month_name(month))
   end

   def test_01a_get_month
   	 month = "11"
   	 assert_equal("November", get_month_name(month))
   end
  def test_01b_get_month
   	 month = "01"
   	 assert_equal("January", get_month_name(month))
   end
 ...
 def test_02c_leap_year_offset
 	month = "9"
 	year = "2012"
 	assert_equal(628, leap_year_offset(month, year))
  end
  ...
  def test_04_string_lentgh
  	month = "9"
  	year = "2012"
  	assert_equal(88 ,day_of_the_week_printer(month, year).to_s.length)
  end
